...
export default function RapPortfolioPage() {
  const initialData = [
    { id: 1, title: '랩 영상 1', description: '랩 영상 설명', thumbnail: 'path/to/thumbnail1.jpg' },
    { id: 2, title: '랩 영상 2', description: '랩 영상 설명', thumbnail: 'path/to/thumbnail2.jpg' },
    { id: 3, title: '랩 영상 3', description: '랩 영상 설명', thumbnail: 'path/to/thumbnail3.jpg' },
    // 더 많은 데이터...
  ];
  ...
  return (
    <div className="p-10">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold">비디오 포트폴리오 | 랩</h1>
        {isEditing ? (
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {paginatedData.map(item => (
          <div key={item.id} className="relative border p-4 rounded">
            ...
            <Link to={`/portfolio/rap?id=${item.id}`}>
