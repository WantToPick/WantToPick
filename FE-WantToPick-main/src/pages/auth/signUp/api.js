...
export const saveName = async (name) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/name`, { name });
...
export const saveBirthDate = async (birthdate) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/birthdate`, { birth_date: birthdate }); // 수정된 필드 이름
...
export const saveGender = async (gender) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/gender`, { gender });
...
export const saveUsername = async (username) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/username`, { username });
...
export const savePassword = async (password) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/password`, { password });
